...
@tranzy_router.get("/vehicles/route-short-name")
def get_vehicles_by_route_short_name(route_short_name: str, direction_id: int, db: db_dependency):
...
def get_stops_by_route_id(route_id: str, db: db_dependency):
    return tranzy_service.get_stops_by_route_id(route_id, db)


@tranzy_router.get("/stops/route/stop-times/")
