...
const StatsCard = ({ icon, title, userData }) => {
    return (
        <Card className="w-42 bg-primary md:p-4 h-48 md:h-52 lg:h-64 md:w-40 lg:w-44 rounded-2xl shadow-md flex flex-col items-center justify-center">
            ...
            <div className="text-xs md:text-sm text-gray-300 text-center">
